...
/*        final double lat = lm.getLastKnownLocation(LocationManager.NETWORK_PROVIDER).getLatitude();
        ...
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                mMap.clear();
                Toast.makeText(MapaActivity.this, "Localização: " + latLng.latitude + "-" + latLng.longitude, Toast.LENGTH_LONG).show();
        ...
        LatLng unoesc = new LatLng(50, 50);
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(unoesc, 15f));
    }
}
